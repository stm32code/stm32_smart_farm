...
#endif
// 设备信息
#define PROID "smartdevice&h9sj4vs2jeY"															 // 产品ID
#define DEVID "h9sj4vs2jeY.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1713769608566|" // 设备ID
#define AUTH_INFO "43c9673341130e27b558f091da75fa3ad02fe5bd55055961aa31da53f95e6170"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/h9sj4vs2jeY/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/h9sj4vs2jeY/test2" // 需要发布的主题

#define P_TOPIC_CMD "/sys/h9sj6OXWcXX/smartdevice/thing/event/property/post"
